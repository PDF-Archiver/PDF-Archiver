...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/SwiftUIX/SwiftUIX", from: "0.1.5"),
        .package(url: "https://github.com/dasautoooo/Parma", from: "0.3.0"),
        .package(url: "https://github.com/WeTransfer/Diagnostics", from: "4.4.1"),
        ...
        .package(name: "Sentry", url: "https://github.com/getsentry/sentry-cocoa", from: "8.7.2")
    ],
    targets: [
