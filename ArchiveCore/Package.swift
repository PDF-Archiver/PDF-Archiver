...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/WeTransfer/Diagnostics", from: "1.12.0"),
        .package(url: "https://github.com/tikhop/TPInAppReceipt", from: "3.3.2"),
        .package(url: "https://github.com/shaps80/GraphicsRenderer", from: "1.4.4"),
        .package(name: "Sentry", url: "https://github.com/getsentry/sentry-cocoa", from: "7.5.0")
    ],
    targets: [
