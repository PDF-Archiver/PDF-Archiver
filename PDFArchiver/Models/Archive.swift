...
//            return
//        }
//        guard let tagManager = self.dataModelTagsDelegate?.getTagManager() else {
//            os_log("TagManager not found.", log: self.log, type: .fault)
//            return
//        }
//
...
//                self.documents.append(Document(path: file, tagManager: tagManager, size: 0, downloadStatus: .local))
//            }
////            self.dataModelTagsDelegate?.setTagList(tagList: tags)
//            dataModelTagsDelegate?.updateView(updatePDF: false)
//        }
//    }
//
